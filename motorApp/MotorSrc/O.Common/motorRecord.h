...
{
    motorRecord *prec = 0;
  assert(pdbRecordType->no_fields==165);
  ...
  pdbRecordType->papFldDes[164]->size=sizeof(prec->igset);
  pdbRecordType->papFldDes[164]->offset=(short)((char *)&prec->igset - (char *)prec);
